...
#ifdef AL_NozFor_c
	#define AL_NozFor_ext
#else
	#define AL_NozFor_ext extern
#endif
...
//动作函数-----------------------------------------------------------------------------------------//
void AL_NozFor(void *FP,FActAttrStr *FAAP);
	#define mASID_AL_NozFor_NozFor			10	//座进
	#define mASID_AL_NozFor_NozFor_AM		20	//调模座进

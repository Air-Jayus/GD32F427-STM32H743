...
#ifdef AL_MotDrv_c
	#define AL_MotDrv_ext
#else
	#define AL_MotDrv_ext extern
#endif
...
//动作函数-----------------------------------------------------------------------------------------//
void AL_MotDrvOff(void *FP,FActAttrStr *FAAP);
	#define mASID_AL_MotDrvOff_MDOff		10	//驱动器关

void MotDrv_Pcs(void);							//伺服驱动器处理

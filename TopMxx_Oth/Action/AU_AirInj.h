...
#ifdef AU_AirInj_c
	#define AU_AirInj_ext
#else
	#define AU_AirInj_ext extern
#endif
...
//动作函数-----------------------------------------------------------------------------------------//
void AU_AirInj(void *FP,FActAttrStr *FAAP);
	#define mASID_AU_AirInj_MonInj		10	//等待注射到位
	#define mASID_AU_AirInj_AirInj		20	//气辅注射

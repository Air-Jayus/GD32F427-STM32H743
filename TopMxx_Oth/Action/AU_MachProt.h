...
****************************************************************************************************/
#ifndef AU_MachProt_h
	#define AU_MachProt_h

#ifdef AU_MachProt_c
	#define AU_MachProt_ext
#else
	#define AU_MachProt_ext extern
#endif
...
//动作函数-----------------------------------------------------------------------------------------//
void AU_MachProt(void *FP,FActAttrStr *FAAP);
	#define mASID_AU_MachProt_Wait		10	//

...
#define mState_DAC1Out           96             //DA通道1输出                             高字节为通道限值、低8位为通道当前输出
#define mState_DAC2Out           97             //DA通道2输出                             高字节为通道限值、低8位为通道当前输出
#define mState_DAC3Out           98             //DA通道3输出                             高字节为通道限值、低8位为通道当前输出
#define mState_DAC4Out           99             //DA通道4输出                             高字节为通道限值、低8位为通道当前输出
#define mState_DAC5Out           100            //DA通道5输出                             高字节为通道限值、低8位为通道当前输出
#define mState_DAC6Out           101            //DA通道6输出                             高字节为通道限值、低8位为通道当前输出
#define mState_DAC7Out           102            //DA通道7输出                             高字节为通道限值、低8位为通道当前输出
#define mState_DAC8Out           103            //DA通道8输出                             高字节为通道限值、低8位为通道当前输出
...
#define mState_282               282            //                                    
#define mState_283               283            //                                    
#define mState_284               284            //                                    
#define mState_285               285            //                                    
#define mState_286               286            //                                    
#define mState_287               287            //                                    
#define mState_288               288            //                                    
#define mState_289               289            //                                    
...
#define State_51                 WorkState[51]  //                                    
#define State_52                 WorkState[52]  //                                    
...
#define State_DAC1Out            WorkState[96]  //DA通道1输出                             高字节为通道限值、低8位为通道当前输出
#define State_DAC2Out            WorkState[97]  //DA通道2输出                             高字节为通道限值、低8位为通道当前输出
#define State_DAC3Out            WorkState[98]  //DA通道3输出                             高字节为通道限值、低8位为通道当前输出
#define State_DAC4Out            WorkState[99]  //DA通道4输出                             高字节为通道限值、低8位为通道当前输出
#define State_DAC5Out            WorkState[100] //DA通道5输出                             高字节为通道限值、低8位为通道当前输出
#define State_DAC6Out            WorkState[101] //DA通道6输出                             高字节为通道限值、低8位为通道当前输出
#define State_DAC7Out            WorkState[102] //DA通道7输出                             高字节为通道限值、低8位为通道当前输出
#define State_DAC8Out            WorkState[103] //DA通道8输出                             高字节为通道限值、低8位为通道当前输出
...
#define State_282                WorkState[282] //                                    
#define State_283                WorkState[283] //                                    
#define State_284                WorkState[284] //                                    
#define State_285                WorkState[285] //                                    
#define State_286                WorkState[286] //                                    
#define State_287                WorkState[287] //                                    
#define State_288                WorkState[288] //                                    
#define State_289                WorkState[289] //                                    

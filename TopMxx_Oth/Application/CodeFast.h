...
#define CC_Debug_Set	0x20//调试设置 格式：CC_Debug_Set DBT DBP----DBT为类型、DBP为IO序号或DA值
	...
	#define mDBT_Link_SP_Pres	26	//联动组合	小泵压力	20130526应天剑快速机
	#define mDBT_Link_LP_Pres	27	//联动组合	大泵压力	20130526应天剑快速机
	#define mDBT_Link_LP_Flow	28	//联动组合	大泵流量	20130526应天剑快速机
	#define mDBT_Link_SysPres	29	//联动组合	系统压力	20130526应天剑快速机
	#define mDBT_Link_SysFlow	30	//联动组合	系统流量	20130526应天剑快速机
...
#define CC_CntClr		0x25//计数清0	格式：CC_CntClr   Cntn	  ----Cntn为序号，0-开模数 1-装模数 2-不良品数
	...
	#define mPwr_TtlKWhClr		7	//累计用电量清零	20130821加
	#define mPwr_PwrPHourClr	8	//单位时间用电量清零	20130821加
	#define mPwr_PwrPCntClr		9	//单位模数用电量清零	20130821加
...
//20141015：增加以下四条驱动器相关指令（前3条为SDO读写相关）
#define CC_MDDrv_RdyData		0x2A	//准备n（0-3）驱动器的第x地址数据：主机启动向驱动器读取第X地址数据（SDO）
										//格式：CC_MDDrv_RdyData   SDSN  HIndex  LIndex  SIndex
#define CC_MDDrv_ReadData		0x2B	//读取n（0-3）驱动器的第x地址数据
										//格式：CC_MDDrv_RdyData   SDSN  HIndex  LIndex  SIndex 
										//返回：CC_MDDrv_RdyData   SDSN  HIndex  LIndex  SIndex Data1-Data4
										//注：界面发出CC_MDDrv_RdyData指令后，以50ms间隔通过本指令读取驱动器SDO数据，如主机尚未从驱动器读取到，则返回SDSN=0xff
#define CC_MDDrv_MdyData		0x2C	//修改n（0-3）驱动器的第x地址数据
										//格式：CC_MDDrv_MdyData  SDSN  HIndex  LIndex  SIndex  Data1-Data4
#define CC_MDDrv_SetCurrSDSN	0x2D	//设置当前驱动器：
...
#define CC_ServoDrvSet	0x32//伺服驱动器设置	格式：CC_ServoDrvSet SetFun SDSN Mode ParaH ParaL
	#define mSDS_MotTune		1	//调谐		Mode=1静态调谐	Mode=2动态调谐
	#define mSDS_Init			2	//初始化		Mode=1			Mode=2
	...
	#define mSDS_AISetZero		10	//模拟量校零	Mode=1 AI1      Mode=2 AI2 		Mode=3 AI3 
...
#define CC_MoldAdjLubr	0x34//调模润滑	格式：CC_MoldAdjLubr mMAL_LubrFin/mMAL_LubrStart		20150609加
	#define mMAL_LubrFin		0	//结束
	#define mMAL_LubrStart		1	//开始
#define CC_SetDateTime  0x35//设置日期、时间 格式：CC_SetDateTime YY MM DD HH MM SS				20150609加

#define CC_MOParaAutoGenl	0x36//开模参数自学习
	#define mMOPAG_Start	1	//开模参数自学习开始
	#define mMOPAG_Finish	0	//开模参数自学习结束
	#define mMOPAG_PraGenAss	10	//智能辅助开模时，初始参数产生
	
#define CC_MOLineGenl	0x37//开模参数线性生成
//#define CC_ReadManuPara 0x38	//读取生产参数	在Comm_Drv.c中定义
#define CC_ProdTaskFin	0x39	//生产任务完成	20170705

#define CC_SrwWaveSet		0x3A//螺杆曲线示波器设置	CC_SrwWaveSet SampTime （SampTime=0时表示退出注射曲线采集）20190809
#define CC_SrwWaveRead		0x3B//螺杆曲线数据读取		CC_SrwWaveRead DatSnH DatSnL DatNum 	DatSnH DatSnL读取数据点开始的序号 DatNum读取数据点个数
...
#define mActStopCode 0x40	//动作停止代码与动作代码相差的值

#define	mMACode_Start		0x60		//模式、动作指令		起始代码
#define mMACode_End			0xAf		//模式、动作指令		结束代码

#define mActCode_Start		0x70		//动作指令按下		起始代码
#define mActCode_End		0xAf		//动作指令按下		结束代码

#define mActCodePop_Start	(0x70+0x40)	//动作指令放开		起始代码
#define mActCodePop_End		(0xAf+0x40)	//动作指令放开		结束代码
...
#define mCode_Air9			mActCode+46	//吹气9			20140428加
#define mCode_Air10			mActCode+47	//吹气10		20140428加
#define mCode_Air11			mActCode+48	//吹气11		20140428加
#define mCode_Air12			mActCode+49	//吹气12		20140428加
...
#define mCode_Air9Stop			mCode_Air9			+mActStopCode//吹气9			20140428加
#define mCode_Air10Stop			mCode_Air10			+mActStopCode//吹气10			20140428加
#define mCode_Air11Stop			mCode_Air11			+mActStopCode//吹气11			20140428加
#define mCode_Air12Stop			mCode_Air12			+mActStopCode//吹气12			20140428加

//指令、动作对应关系转换				
//在Action.c中定义了ManuModeCodeActTab[mActCodeMaxNum]、MoldAdjModeCodeActTab[mActCodeMaxNum]两个数组，反应指令对应的动作
#define mActCodeMaxNum			(48+16)				//动作指令最大数		Action.c中利用此宏定义数组长度		实际使用31，如果超出40则要修改本宏，
													//20140428增加后16个
